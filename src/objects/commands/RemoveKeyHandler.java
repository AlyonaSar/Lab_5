...
public class RemoveKeyHandler extends CommandHandler implements IObserver {

    ProductLHMHandler productLHMHandler_;

    public RemoveKeyHandler(IObservable productLHMHandler) {
    ...
    public void run(String[] input_array) throws InvalidParameterException, ArrayIndexOutOfBoundsException {
        try {
            ...
            productLHMHandler_.remove_element(key);
