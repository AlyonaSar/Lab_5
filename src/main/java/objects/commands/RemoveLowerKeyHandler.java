...
public class RemoveLowerKeyHandler extends CommandHandler {
    private Space space_;
    public RemoveLowerKeyHandler(String space_name) {
    ...
    public void run(String[] input_array) {
        ...
        try {
            ...
            ProgrammingHelpie.comment("Removed keys lower than: " + key);
